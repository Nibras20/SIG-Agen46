    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            <div
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar-lg me-4">
                        <img src="{{ asset ('assets/img/nophotoadmin.png') }}"
                            class="card-img-top rounded-circle border-white" alt="Nibras Gani">
                    </div>
                    <div class="d-block">
            ...
            <ul class="nav flex-column pt-md-0">
                ...
                <li class="nav-item {{ Request::is('list-agen46admin') ? 'active' : '' }}">
                    <a href="{{ route('list-agen46admin') }}" class="nav-link">
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <span class="sidebar-text">List Agen46</span>
                    </a>
                </li>

                <li class="nav-item {{ Request::is('simple-v2admin') ? 'active' : '' }}">
                    <a href="{{ route('simple-v2admin') }}" class="nav-link ">
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <ul class="navbar-nav align-items-center">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="{{ asset ('assets/img/nophotoadmin.png') }}"
                                                    class="avatar-md rounded">
                                            </div>
                                            <div class="col ps-0 ms-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="h6 mb-0 text-small">Nibras Gani</h4>
                                                    </div>
                                                    <div class="text-end">
                                                        <small>2 hrs ago</small>
                                                    </div>
                                                </div>
                                                <p class="font-small mt-1 mb-0">New message: "Semangat Skiripsi."</p>
                                            </div>
                                        </div>
                                    </a>
                        ...
                        <li class="nav-item dropdown ms-lg-3">
                            <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button"
                                ...
                                <div class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                                        <span class="mb-0 font-small fw-bold text-gray-900">Nibras Gani</span>
                                    </div>
                                </div>
                            </a>
                            ...
                            <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="proseslogoutadmin">
