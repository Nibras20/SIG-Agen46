...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/img/logobnicrop.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/img/logobnicrop.png') }}">
    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-md-0">
                ...
                <li class="nav-item {{ Request::is('list-agen46') ? 'active' : '' }}">
                    <a href="{{ route('list-agen46') }}" class="nav-link">
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                ...
                <li class="nav-item {{ Request::is('simple-v2') ? 'active' : '' }}">
                    <a href="{{ route('simple-v2') }}" class="nav-link ">
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="row">
                <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
                    <p class="mb-0 text-center text-lg-start">© 2024-<span class="current-year"></span> <a
                            class="text-primary fw-normal" href="" target="_blank">PT Bank Negara Indonesia
                            (Persero) Tbk</a></p>
                </div>
